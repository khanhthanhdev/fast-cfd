...
export const CATALOG_ITEMS: AssetInput[] = [
  ...
  // HVAC Diffusers - Structure (S) category
  {
    id: 'diffuser-in',
    category: 'structure',
...

  {
    id: 'supply-diffuser',
    category: 'appliance',
    tags: ['ceiling', 'hvac', 'supply', 'climate'],
    name: 'Supply Diffuser',
    thumbnail: '/items/supply-diffuser/thumbnail.svg',
    src: '/items/supply-diffuser/model.glb',
    scale: [1, 1, 1],
    offset: [0, 0.98, 0],
    rotation: [0, 0, 0],
    dimensions: [0.6, 0.15, 0.6],
...

  {
    id: 'return-grille',
    category: 'appliance',
    tags: ['ceiling', 'wall', 'hvac', 'return', 'climate'],
    name: 'Return Grille',
    thumbnail: '/items/return-grille/thumbnail.svg',
    src: '/items/return-grille/model.glb',
    scale: [1, 1, 1],
    offset: [0, 0.98, 0],
    rotation: [0, 0, 0],
    dimensions: [1.2, 0.1, 0.3],
    attachTo: 'ceiling',
  },

  {
    id: 'linear-diffuser',
    category: 'appliance',
    tags: ['ceiling', 'wall', 'hvac', 'supply', 'climate'],
    name: 'Linear Diffuser',
    thumbnail: '/items/linear-diffuser/thumbnail.svg',
    src: '/items/linear-diffuser/model.glb',
    scale: [1, 1, 1],
    offset: [0, 0.98, 0],
    rotation: [0, 0, 0],
    dimensions: [1.2, 0.1, 0.2],
    attachTo: 'ceiling',
  },
]
